...
class TransRKnowledgeGraphEmbedding:
    def __init__(self, embedding_dim=30, config_path='app/config/config.yaml'):
    ...
    def train_model(self, triples, embedding_dim=None, num_epochs=100):
      ...
      model = TransR(triples_factory=train_tf, embedding_dim=embedding_dim)
    ...
    def predict_tail_entities(self, head_entity, relation, top_k=3):
...
"""
  ...
  kge = TransRKnowledgeGraphEmbedding()
